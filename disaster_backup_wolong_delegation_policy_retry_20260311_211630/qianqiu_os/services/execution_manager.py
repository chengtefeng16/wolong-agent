...
class ExecutionManager:
    ...
    def simulate_execution(self, execution_task):
        ...
        block_reason = delivery_gate.get("block_reason")
        ...
        for step in execution_task.get("execution_steps", []) or []:
            ...
            if executor in ("api", "browser", "desktop"):
                ...
                if send_blocked_by_gate:
                    msg = f"{executor} 执行器已被人工复核闸门拦截：{action}"
                    exec_status = "blocked_by_gate"
