...
class RuntimeRegressionSuiteV1:
    ...
    def run(self):
        ...
        checks.append({
            ...
            "detail": "delegation_active_config.json exists" if active_config is not None else "delegation_active_config.json missing",
        })
