...
class KnowledgeAccessLayer:
    ...
    def load_wolong_faq_pack(self):
        return self.load_json("knowledge/wolong/faq_pack_v1.json")

    def load_wolong_rule_pack(self):
        return self.load_json("knowledge/wolong/rule_pack_v1.json")
