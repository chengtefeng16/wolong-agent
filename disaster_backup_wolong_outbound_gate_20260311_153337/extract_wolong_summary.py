...
def main():
    ...
    summary = {
        ...
        "execution_task": {
            ...
            "desktop_text_payload": {"text": None},
        },
        "execution_result": {
            "execution_status": safe_get(data, "execution_result", "execution_status"),
            "mainline_execution_status": safe_get(data, "execution_result", "mainline_execution_status"),
            "mainline_failed_step_count": safe_get(data, "execution_result", "mainline_failed_step_count"),
            "test_layer_fault_active": safe_get(data, "execution_result", "test_layer_fault_active"),
            "test_layer_execution_status": safe_get(data, "execution_result", "test_layer_execution_status"),
            "status_separation": safe_get(data, "execution_result", "status_separation"),
            "status_separation_summary": safe_get(data, "execution_result", "status_separation_summary"),
