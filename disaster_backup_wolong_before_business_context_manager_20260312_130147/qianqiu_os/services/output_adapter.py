...
class OutputAdapter:
    ...
    def _merge_delegation_policy(self, runtime_policy, wolong_policy, source, input_context, business_action_result):
        ...
        if not merged.get("destination_country"):
            merged["destination_country"] = (
                ...
                or metadata.get("destination_country")
                or user_profile.get("destination_country")
            )
