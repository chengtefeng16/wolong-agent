...
from qianqiu_os.services.whatsapp_channel_adapter_v1 import WhatsAppChannelAdapterV1
...
class RealChannelAdapterV1:
    def __init__(self, config_path=None):
        ...
        self.whatsapp_adapter = WhatsAppChannelAdapterV1(config_path=self.config_path)
    ...
    def send(self, payload):
        ...
        if channel == "whatsapp":
            return self.whatsapp_adapter.send(payload)
